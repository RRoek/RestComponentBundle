...
use RRoek\RestComponentBundle\Rest\Exception\RestException;
use RRoek\RestComponentBundle\Rest\RestController;

class RestControllerTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \RRoek\RestComponentBundle\Rest\RestController
     */
