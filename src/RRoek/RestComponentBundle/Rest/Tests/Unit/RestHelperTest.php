...
use RRoek\RestComponentBundle\Rest\RestHelper;
...
class RestHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->listRestHelper = $this->getMockBuilder('RRoek\RestComponentBundle\Rest\ListBuilder\ListRestHelper')
    ...
    {
        $listBuilder = $this->getMockBuilder('RRoek\RestComponentBundle\Rest\ListBuilder\AbstractListBuilder')
            ->getMock();
