...
namespace RRoek\RestComponentBundle\Rest\Tests\Unit;

use RRoek\RestComponentBundle\Rest\Exception\MissingParameterException;
use RRoek\RestComponentBundle\Rest\Exception\ParameterDataTypeException;
use RRoek\RestComponentBundle\Rest\RequestParametersTrait;
...
class RequestParametersTraitTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->requestParametersTrait = $this->getObjectForTrait('RRoek\RestComponentBundle\Rest\RequestParametersTrait');
    }
