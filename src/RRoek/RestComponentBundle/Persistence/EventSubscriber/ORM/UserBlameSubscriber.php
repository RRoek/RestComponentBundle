...
namespace RRoek\RestComponentBundle\Persistence\EventSubscriber\ORM;

use Doctrine\Common\EventSubscriber;
use Doctrine\Common\Persistence\Event\LoadClassMetadataEventArgs;
use Doctrine\ORM\Event\OnFlushEventArgs;
use Doctrine\ORM\Events;
use RRoek\RestComponentBundle\Persistence\Model\UserBlameInterface;
...
class UserBlameSubscriber implements EventSubscriber
{
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $event)
    {
        ...
        if (null !== $reflection && $reflection->implementsInterface('RRoek\RestComponentBundle\Persistence\Model\UserBlameInterface')) {
