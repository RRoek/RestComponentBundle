...
use RRoek\RestComponentBundle\Persistence\Model\TimestampableInterface;
...
class TimestampableSubscriber implements EventSubscriber
{
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $event)
    {
        ...
        if (null !== $reflection && $reflection->implementsInterface('RRoek\RestComponentBundle\Persistence\Model\TimestampableInterface')) {
