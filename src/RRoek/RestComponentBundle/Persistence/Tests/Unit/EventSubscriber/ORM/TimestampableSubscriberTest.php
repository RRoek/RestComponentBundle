...
use RRoek\RestComponentBundle\Persistence\EventSubscriber\ORM\TimestampableSubscriber;
...
class TimestampableSubscriberTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->timestampableObject = $this->prophesize('\stdClass')
            ->willImplement('RRoek\RestComponentBundle\Persistence\Model\TimestampableInterface');
    ...
    public function testLoadClassMetadata()
    {
        ...
        $this->refl->implementsInterface('RRoek\RestComponentBundle\Persistence\Model\TimestampableInterface')->willReturn(true);
