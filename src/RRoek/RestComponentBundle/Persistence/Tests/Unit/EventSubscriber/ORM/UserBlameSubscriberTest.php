...
namespace RRoek\RestComponentBundle\Persistence\Tests\Unit\EventSubscriber\ORM;
...
use RRoek\RestComponentBundle\Persistence\EventSubscriber\ORM\UserBlameSubscriber;
use RRoek\RestComponentBundle\Security\Authentication\UserInterface;
...
class UserBlameSubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->userBlameObject = $this->prophesize('\stdClass')
            ->willImplement('RRoek\RestComponentBundle\Persistence\Model\UserBlameInterface');
        ...
        $this->user = $this->prophesize('RRoek\RestComponentBundle\Security\Authentication\UserInterface');
    ...
    public function testLoadClassMetadata()
    {
        ...
        $this->refl->implementsInterface('RRoek\RestComponentBundle\Persistence\Model\UserBlameInterface')->willReturn(true);
